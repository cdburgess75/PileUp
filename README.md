...
[![version](https://img.shields.io/badge/version-2026.07.16.023-f0923c?style=flat-square)](https://github.com/cdburgess75/PileUp/commits/main)
...
- The Map tab is a **full-screen, immersive map** — the controls float on top of it. **World** shows everything geographically; **Radar** shows an azimuthal view centered on your station, where a marker's angle is the **true bearing to point your antenna**.
- The **World / Radar** and **All / Live spots / Logged** chips overlay the top of the map; switch views and layers without leaving it.
- **Hollow rings are live spots, colored by band; green dots are your logged contacts; the amber dot is you.**
- Opens **centered on your QTH**. **Pinch to zoom — all the way out to the whole globe or in close — drag to pan, double-tap to zoom in** (mouse wheel and double-click on desktop). The **⟲** button recenters on you.
- **Tap any marker** for a full preview — frequency, band, callsign, mode, park/summit reference and name, distance, bearing, age, and comments — with a **＋ Log** button to log it straight from the map. Tap the background or ✕ to dismiss. The bottom nav stays visible — tap another tab to leave.
